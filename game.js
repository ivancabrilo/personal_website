...
//     platforms.push({
//       x: canvas.width - canvas.height * 0.5, // You can set these values according to what looks good
//       y: canvas.height - canvas.height * 0.16,
...
//     const maxDistance = 100; // Maximum distance from the last platform in y-axis
//     const minGapX = canvas.width * 0.1; // Minimum gap in x-axis between consecutive platforms
...
//     do {
//       newX = Math.random() * (canvas.width - canvas.width * 0.6);
//     } while (Math.abs(newX - lastPlatform.x) < minGapX); // Ensure at least mdinGapX difference on the x-axis
